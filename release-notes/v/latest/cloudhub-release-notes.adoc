...
* New link:/runtime-manager/deploying-an-application-to-arm[worker sizing] capabilities for accounts that have link:/runtime-manager/fabric[Fabric] enabled.
...
* Support for link:/runtime-manager/deploying-an-application-to-arm[global deployment] 
* Mule 3.4 support
