...
* Performance improvements for link:/cloudhub/fabric[persistent queues].
...
* New link:/cloudhub/deploying-an-application-to-arm[worker sizing] capabilities for accounts that have link:/cloudhub/fabric[Fabric] enabled.
...
* Support for link:/cloudhub/fabric[persistent queuing].
...
* Support for link:/cloudhub/deploying-an-application-to-arm[global deployment] 
* Mule 3.4 support

== R27 - March 16, 2013

* Improved Insight dashboard with new link:/cloudhub/runtime-manager-insight[Events Filter]
