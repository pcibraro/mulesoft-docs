...
With this release, you csn configure your on-premises Mule or API Gateway runtimes for high availability using clustering, from the CloudHub server management console. For more information, see link:/runtime-manager/creating-and-managing-clusters[Creating and Managing Clusters].
...
* Performance improvements for link:/runtime-manager/fabric[persistent queues].
...
* New link:/runtime-manager/deploying-an-application-to-runtime-manager[worker sizing] capabilities for accounts that have link:/runtime-manager/fabric[Fabric] enabled.
* Support for link:/runtime-manager/worker-monitoring[worker monitoring and automatic restarts], including a link:/runtime-manager/alerts-and-notifications[new alert type] based on a nonresponsive worker.
...
* Support for link:/runtime-manager/fabric[persistent queuing].
...
* Support for link:/runtime-manager/deploying-an-application-to-runtime-manager[global deployment] 
* Mule 3.4 support

== R27 - March 16, 2013

* Improved Insight dashboard with new link:/runtime-manager/runtime-manager-insight[Events Filter]

== R26 - February 15, 2013

* Ability to access the link:/runtime-manager/community-and-support[support portal]
