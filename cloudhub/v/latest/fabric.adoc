...
[TIP]
For specs and details about each of the worker sizes see the *Worker Sizing* section of link:/cloudhub/deploying-an-application-to-arm[Deploying an Application to ARM]
