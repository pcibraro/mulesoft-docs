...
For more information about the console, see link:/cloudhub/cloudhub-console-overview[Runtime Management Console Overview]. For more information about using the console for account management, see link:/anypoint-platform-administration[Account Management].
...
With link:/cloudhub/cloudhub-fabric[Fabric], you can also scale your applications horizontally by adding multiple workers and load distribution over queues. For more information about scaling workers, see link:/cloudhub/cloudhub-fabric[Worker Scaleout]. For more information about using persistent queues on CloudHub, see link:/cloudhub/cloudhub-fabric[Persistent Queues].
...
link:/cloudhub/cloudhub-fabric#worker-scaleout[Fabric worker scaleout], and link:/cloudhub/cloudhub-fabric#persistent-queues[persistent queueing] features.
...
For more details about worker scale-out and persistent queues, refer to link:/cloudhub/cloudhub-fabric[Fabric].
