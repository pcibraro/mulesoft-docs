...
This tutorial builds on existing tutorials, so to begin, build a service using the link:/cloudhub/hello-world-on-cloudhub[Hello World] tutorial.
...
For more details on how this is configured, see the link:/mule-user-guide/v/3.6/http-connector[HTTP Connector] documentation.
