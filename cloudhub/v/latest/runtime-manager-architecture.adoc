...
For more about creating and deploying integration applications, see link:/cloudhub/getting-started-with-cloudhub[Getting Started with ARM] and link:/cloudhub/deploying-an-application-to-arm[Deploying an Application to ARM].
