...
By default, CloudHub tracks the most recent 100,000 events which occurred within your application. To arrange to track more, you can file a claim in the MuleSoft link:/cloudhub/community-and-support[support portal].
