= The Mule Agent
:keywords: cloudhub, api, mule agent, plugin, enterprise, rest, websockets, arm, runtime manager
...
Additionally, it is assumed that your Enterprise license is current. Please see link:/runtime-manager/installing-an-enterprise-license[Installing an Enterprise License] for information on obtaining and installing an enterprise license.
