= Amazon RDS Support
:keywords: cloudhub, security, arm, runtime manager

You can easily integrate an application that's deployed to CloudHub with MySQL or Oracle using Amazon Relational Database Service (RDS). Refer to the link:http://aws.amazon.com/rds/[Amazon RDS documentation] to learn how to set up a new database.
...
You can now use the JDBC connector inside your CloudHub deployed application with RDS.
