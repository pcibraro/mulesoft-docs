...
When you create an app specifically for deploying to CloudHub, Mule's Integration Platform as a Service (iPaaS), there are a few special considerations to take into account. The best way to learn how to develop a CloudHub application is to read the link:/runtime-manager/getting-started-with-runtime-manager[Getting Started with Runtime Manager] guide, which includes walkthroughs of basic concepts and examples to help get you familiar with the process of developing and deploying your applications in CloudHub. 
...
* Learn about link:/runtime-manager/deploying-an-application-to-runtime-manager[Deploying an Application to Runtime Manager]
* After you develop and deploy your application, see link:/runtime-manager/managing-applications-on-runtime-manager[Managing Applications on Runtime Manager] at runtime.
