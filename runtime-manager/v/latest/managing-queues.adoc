...
* Learn more about the advantages of link:/runtime-manager/fabric[Fabric].
* Learn how to link:/runtime-manager/fabric#cloudhubfabric-building[set up your applications in reliability patterns] to reap the benefits of persistent queueing.
