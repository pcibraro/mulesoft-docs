...
This document assumes that you are familiar with link:/runtime-manager/deploying-an-application-to-arm[Deploying Applications to ARM] and that you are deploying for a runtime version newer than 3.4.0. 
