...
This document assumes that you are familiar with link:/runtime-manager/deploying-an-application-to-runtime-manager[Deploying Applications to Runtime Manager] and that you are deploying for a runtime version newer than 3.4.0. 
