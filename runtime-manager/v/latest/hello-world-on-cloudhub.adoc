...
This Hello World tutorial helps you come up to speed quickly with CloudHub. It introduces both CloudHub and Any`point Studio, the free development tool. You can see how easy it is to build your first project, create an Anypoint Platform organization, and then deploy your project to the cloud. Be sure to first take a look at link:/runtime-manager/runtime-manager-at-a-glance[Runtime Manager at a Glance] – a brief guide that introduces some of the basic CloudHub and Anypoint Studio concepts.
...
The following steps walk you through building a simple Anypoint Studio project that creates a HTTP server within your project, and once deployed to CloudHub, echoes "Hello World" in a browser web page.
...
Next we create an organization in the Anypoint Platform, upload the project, and then deploy it.

== Creating an Organization in the Anypoint Platform
...
After you create your Anypoint Platform account, you are directed to the landing page. From the main menu, select the *Runtime Manager* link.
