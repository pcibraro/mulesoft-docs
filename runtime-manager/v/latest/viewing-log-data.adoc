...
* When you enable enhanced logging, CloudHub restarts your application, with link:runtime-manager/managing-applications-on-runtime-manager#zero-downtime-updates-with-cloudhub[*zero downtime*].
