= Runtime Manager Insight
:keywords: cloudhub, analytics, monitoring, insight, filter, arm, runtime manager
...
By default, CloudHub tracks the most recent 100,000 events which occurred within your application. To arrange to track more, you can file a claim in the MuleSoft link:/runtime-manager/community-and-support[support portal].

[IMPORTANT]
Insight does not support visibility into link:/mule-user-guide/v/3.6/batch-processing[batch processing].
...
* Read more about Insight on our link:http://blogs.mulesoft.org/announcing-cloudhub-insight-real-time-visibility-message-replay-and-root-cause-analysis/[MuleSoft Blog].
