...
For a full description of the steps outlined in this section, see the *Add a Server* section in link:/cloudhub/managing-servers-on-premises[Managing Servers On Premises].
