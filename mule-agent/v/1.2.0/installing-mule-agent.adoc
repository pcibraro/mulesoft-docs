...
[IMPORTANT]
====
Mule 3.7.x and API Gateway 2.x provide an link:/mule-agent/v/1.1.1/index[older version of the Mule Agent]. This version doesn't provide support for link:/cloudhub/sending-data-from-arm-to-external-monitoring-software[Sending Data from ARM to External Monitoring Software]. Version 1.2.0 of the Agent must be downloaded separately.
====
...
For details, see the *Add a Server* section in link:/cloudhub/managing-servers-on-premises[Managing Servers On Premises.]
